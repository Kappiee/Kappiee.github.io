<template><div><h1 id="面向对象简介" tabindex="-1"><a class="header-anchor" href="#面向对象简介"><span>面向对象简介</span></a></h1>
<p>面向对象：一种编程思想，跟具体的语言</p>
<p>对比面向过程：</p>
<p>【大象装冰箱】示例</p>
<h2 id="面向过程-思考的切入点是功能的步骤" tabindex="-1"><a class="header-anchor" href="#面向过程-思考的切入点是功能的步骤"><span>面向过程：思考的切入点是功能的步骤</span></a></h2>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="line"><span class="token comment">// 1. 冰箱门打开</span></span>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="面向对象-思考的切入点是对象的划分" tabindex="-1"><a class="header-anchor" href="#面向对象-思考的切入点是对象的划分"><span>面向对象：思考的切入点是对象的划分</span></a></h2>
